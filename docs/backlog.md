...
| 📚 | ⏳ To Do | #10 | **Issue #10: Mistral OCR AI for PDF Parsing**<br>Substituir ou complementar o `pdfplumber` com Mistral OCR AI para leitura robusta de PDFs complexos e tabelas. | 8 |
