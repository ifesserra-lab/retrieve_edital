...
| 📚 | ✅ Done | #9 | **Issue #9: Multi-URL Support for FAPES**<br>Adicionar suporte para varredura em múltiplas URLs: Extensão, Pesquisa, Inovação e Chamadas Internacionais. | 5 |
